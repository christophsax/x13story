...
```{r, echo = FALSE}
library(13story)  # this will also load seasonal

m <- seas(AirPassengers)

# initializes a first interactive X-13 view.
...
```{r echo = FALSE, fig.width = 10, fig.height = 6, fig.cap = "An example of a pretty plot."}
prettyplot(myseries)
```

```{r, echo = FALSE, results='asis'}
prettysummary(m, caption = "An example of a pretty summary.")
```
