...
2. For documentation, using markdown and knitr, an R script is easily transfered in a reproducible research document, which can be shared and published as a PDF. 
...
`prettysummary2`
  : like `prettysummary`, but can be used for multiple models. Gives a nice model comparison table, but needs some more work (and another name) ....
...
prettysummary(m, "An example of the prettysummary function")
```
